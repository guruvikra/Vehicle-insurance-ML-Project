# TODO: this is totally copied from a youtube you need to learn this vikram
...
def error_message_detail(error: Exception, error_detail: sys) -> str:
    ...
    # here acutally the function return three things onw is what type of error and other is error message and the last is traceback from where the line and the file etc
